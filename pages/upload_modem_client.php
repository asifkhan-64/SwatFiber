<?php
    ...
    if (isset($_POST["addUser"])) {
            ...
            if (empty($DP)) {
                ...
                $updateQuery = mysqli_query($connect, "UPDATE client_tbl SET modem_image = '$profileNewName' WHERE client_id = '$id'");
            ...
            <div class="col-12">
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <h4 class="mt-0 header-title text-center">Modem Image</h4>
                            </div>
                        ...
                        <div class="form-group row"> 
                            ...
                            if (empty($fetUserData['modem_image'])) {
                                ...
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <img src="../__images/'.$fetUserData['modem_image'].' "width="100%" style="border-radius: 10px; box-shadow: 3px 3px 3px 3px #ccc" height="auto" ><hr >
                                </div>
