                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row"> 
                            ...
                            if (empty($fetUserData['profile_image'])) {
                                ...
                                echo '
                                <div class="col-sm-4 text-center animate__animated animate__bounce" align="center">
                                    <img src="../__images/'.$fetUserData['profile_image'].' "width="100%" style="border-radius: 10px; box-shadow: 3px 3px 3px 3px #ccc" height="auto" >
                        ...
                        <div class="form-group row"> 
                            ...
                            if (empty($fetUserData['profile_image'])) {
                                ...
                                <div class="col-sm-4 text-center" align="center">
                                    <a href="upload_profile.php?id='.$id.'" class="btn btn-secondary">Add Image</a>
                                </div>
                                ';
                            }else {
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <a href="upload_profile.php?id='.$id.'" class="btn btn-warning">Update Image</a>
                            ...
                            if (empty($fetUserData['cnic_front'])) {
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <a href="upload_cnicfront.php?id='.$id.'" class="btn btn-secondary">Add Image</a>
                                </div>
                                ';
                            }else {
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <a href="upload_cnicfront.php?id='.$id.'" class="btn btn-primary">Update Image</a>
                                </div>
                                ';
                            }
                            ?>
                            ...
                            if (empty($fetUserData['cnic_back'])) {
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <a href="upload_cnicback.php?id='.$id.'" class="btn btn-secondary">Add Image</a>
                                </div>
                                ';
                            }else {
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <a href="upload_cnicback.php?id='.$id.'" class="btn btn-success">Update Image</a>
                                </div>
                                ';
                            }
                            ?>
