<?php
    ...
    $id = $_GET['id'];
    $getUserData = mysqli_query($connect, "SELECT * FROM client_tbl WHERE client_id = '$id'");
    ...
    if (isset($_POST["addUser"])) {
            ...
            if (empty($DP)) {
                ...
                $updateQuery = mysqli_query($connect, "UPDATE client_tbl SET cnic_front = '$profileNewName' WHERE client_id = '$id'");

                if (!$updateQuery) {
                    $userNotAdded = "<div class='alert alert-primary' role='alert'>Image not added! Try Again.</div>";
                }else{
                    header("LOCATION: client_view.php?id=".$id."");
                }
            }
            ...
            <div class="col-12">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 text-right">
                        ...
                        <button type="submit" name="addUser" class="btn btn-primary waves-effect waves-light">Update Image</button>
                    </div>
                </div>
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <h4 class="mt-0 header-title text-center">CNIC Front Image</h4>
                            </div>
                        ...
                        <div class="form-group row"> 
                            ...
                            if (empty($fetUserData['cnic_front'])) {
                                ...
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <img src="../__images/'.$fetUserData['cnic_front'].' "width="100%" style="border-radius: 10px; box-shadow: 3px 3px 3px 3px #ccc" height="auto" ><hr >
                                </div>
