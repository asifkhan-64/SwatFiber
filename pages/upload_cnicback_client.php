<?php
    ...
    if (isset($_POST["addUser"])) {
            ...
            if (empty($DP)) {
                ...
                $updateQuery = mysqli_query($connect, "UPDATE client_tbl SET cnic_back = '$profileNewName' WHERE client_id = '$id'");
            ...
            <div class="col-12">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 text-right">
                        ...
                        <button type="submit" name="addUser" class="btn btn-primary waves-effect waves-light">Update Client</button>
                    </div>
                </div>
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <h4 class="mt-0 header-title text-center">CNIC Back Image</h4>
                            </div>
                        ...
                        <div class="form-group row"> 
                            ...
                            if (empty($fetUserData['cnic_back'])) {
                                ...
                                echo '
                                <div class="col-sm-4 text-center" align="center">
                                    <img src="../__images/'.$fetUserData['cnic_back'].' "width="100%" style="border-radius: 10px; box-shadow: 3px 3px 3px 3px #ccc" height="auto" ><hr >
                                </div>
