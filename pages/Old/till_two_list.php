...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Till-2 Report List</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <?php
                                $tillTwoReports = mysqli_query($connect, "SELECT * FROM till_two_reports ORDER BY report_date DESC");
                                $iteration = 1;

                                while ($rowReport = mysqli_fetch_assoc($tillTwoReports)) {
                                    echo '
                                    <tr>
                                         <td>' . $iteration++ . '</td>
                                         ...
                                         echo '
                                         <td class="text-center"><a href="till_two_edit.php?id=' . $rowReport['two_id'] . '" type="button" class="btn text-white btn-warning waves-effect waves-light">Edit</a></td>
                                    </tr>
                                    ';
                                }
                                ?>
