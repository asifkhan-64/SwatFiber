<?php
    ...
    $getUtilityExpenses = mysqli_query($connect, "SELECT expense.*, expense_category.expense_name FROM `expense`
    ...
    $fetch_getUtilityExpenses = mysqli_fetch_assoc($getUtilityExpenses);
