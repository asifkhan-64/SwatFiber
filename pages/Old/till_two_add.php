...
if (isset($_POST['addTillReport'])) {
    ...
    $checkExisting = mysqli_query($connect, "SELECT * FROM till_two_reports WHERE report_date = '$report_date'");
    if (mysqli_num_rows($checkExisting) > 0) {
        ...
        $insertTillReport = mysqli_query($connect, "INSERT INTO till_two_reports (report_date, z_report, daily_sale, card_payment, cash_payment, refund_payment, total_amount, extra) VALUES ('$report_date', '$z_report', '$daily_sale', '$card_payment', '$cash_payment', '$refund_payment', '$total_amount', '$extra')");
        if (!$insertTillReport) {
            $error = '
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Generate Till 2 Report</h5>
            </div>
        </div>
        <br>
        <!-- end row -->
