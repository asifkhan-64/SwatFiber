...
$id = $_GET['id'];
$getTillReportDetails = mysqli_query($connect, "SELECT * FROM till_one_reports WHERE one_id = '$id'");
...
if (isset($_POST['editTillReport'])) {
    ...
    $updateTillReport = mysqli_query($connect, "UPDATE till_one_reports SET report_date = '$report_date', z_report = '$z_report', daily_sale = '$daily_sale', card_payment = '$card_payment', cash_payment = '$cash_payment', refund_payment = '$refund_payment', total_amount = '$total_amount', extra = '$extra' WHERE one_id = '$id'");
    if (!$updateTillReport) {
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Generate Till 1 Report (Edit)</h5>
            </div>
        </div>
        <br>
        <!-- end row -->
