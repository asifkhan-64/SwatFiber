<?php
    ...
    if (isset($_POST['addPayment'])) {
        ...
        $addPaymentQuery = mysqli_query($connect, "INSERT INTO `client_payments`(`client_id`, `package_amount`, `installation_amount`, `cable_amount`, `other_charges`, `discount_charges`, `total_charges`) VALUES 
        ('$client_id', '$package', '$installation', '$cable', '$other_charges', '$discount_charges', '$total_charges')");
