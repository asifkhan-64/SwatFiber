...
if (isset($_POST["addExpense"])) {
    ...
    $createPayment = mysqli_query($connect, "INSERT INTO pay_done(client_id, amount, added_by, rem_amount, dues, date_pay, bill_desc, payment_method, pay_status)VALUES('$client_id', '$paidAmount', '$addedBy', '$remainingAmount', '$dues', '$billdate', '$billDescription', '$paymentBy', '0')");


	if (!$createPayment) {
		$expenseNotAdded = "Payment not added! Try Again.";
	} else {
		header("LOCATION: dues_payment_list.php");
	}
}
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Receive Dues Payment</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Add Dues Payment</h4>
                        <form method="POST">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Client</label>
                                <div class="col-sm-4">
                                <?php
                                $selectExpenseCat = mysqli_query($connect, "SELECT * FROM client_tbl WHERE added_by = '$addedBy' AND old_remaining > 0 AND client_status = '0' ORDER BY name ASC");
