...
if (isset($_POST["proceed"])) {
	...
	header("LOCATION: bill_print.php?client_id=$client_id");
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Generate Bill</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Generate Client Bill</h4>
                        <form method="POST">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Select Client</label>
                                <div class="col-sm-10">
                                <?php
                                $selectExpenseCat = mysqli_query($connect, "SELECT * FROM client_tbl ORDER BY name ASC");
